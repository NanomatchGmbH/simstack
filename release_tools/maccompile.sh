...
python ../release_tools/git_archive_all.py --prefix=SimStackServer/ ../../compiled_client/lib/python3.7/site-packages/SimStackServer.zip
...
tar czf $TODAY-simstack_osx.tar.gz run-simstack.command simstack simstack.desktop  simstack.eula  tools_mac
