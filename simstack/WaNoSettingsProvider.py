...
class WaNoSettingsProvider(AbstractSettings):
    ...
    def __init__(self, settings_file):
        super(WaNoSettingsProvider, self).__init__(
    ...
    def _set_defaults(self):
        ...
        defaults = [
            ...
            (
                SETTING_KEYS["wanoRepo"],
                os.path.join(pardirpardir, "wanos"),
                "Directory containing the WaNos.",
            ),
            (
                SETTING_KEYS["workflows"],
                os.path.join(pardirpardir, "workflows"),
