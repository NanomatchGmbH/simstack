...
class TestWFEditorApplication:
    ...
    def test_on_workflow_deleted_success(self, app):
        ...
        # Call method with success
        app._on_workflow_deleted("registry", MagicMock(), ErrorCodes.NO_ERROR, workflow=workflow)
    ...
    def test_on_workflow_deleted_error(self, app):
        ...
        # Call method with error
        app._on_workflow_deleted("registry", mock_status, ErrorCodes.CONN_ERROR, workflow=workflow)
        
        # Verify show_error was called
        app._view_manager.show_error.assert_called_once()
        assert "Failed to delete workflow" in app._view_manager.show_error.call_args[0][0]
    ...
    def test_cb_connect_success(self, app):
        ...
        # Call method with success
        app._cb_connect("base_uri", ErrorCodes.NO_ERROR, "status", registry_name=registry_name)
    ...
    def test_cb_connect_error(self, app):
        ...
        # Call method with error
        app._cb_connect("base_uri", ErrorCodes.CONN_ERROR, "status", registry_name=registry_name)
    ...
    def test_connect_remote_empty_registry(self, mock_view_manager_class, app):
        ...
        assert "No server definition" in mock_view_manager_class.show_error.call_args[0][0]
    ...
    def test_update_wanos(self, app):
        ...
        app._WFEditorApplication__load_wanos_from_repo = MagicMock(side_effect=mock_load_wanos)
        ...
        app._WFEditorApplication__load_wanos_from_repo.assert_called_once_with("/path/to/wanos")
    ...
    def test_update_workflow_list_internal(self, app):
        ...
        # Mock methods
        app._WFEditorApplication__load_saved_workflows = MagicMock(return_value=["wf1", "wf2"])
        ...
        # Verify load was called
        app._WFEditorApplication__load_saved_workflows.assert_called_once_with("/path/to/workflows")
        
        # Verify view manager was updated
        app._view_manager.update_saved_workflows_list.assert_called_once_with(["wf1", "wf2"])
    ...
    def test_update_saved_registries(self, app):
        ...
        # Verify view manager was updated
        app._view_manager.update_registries.assert_called_once_with(["reg1", "reg2"], selected=0)
