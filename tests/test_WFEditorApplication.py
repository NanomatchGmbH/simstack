...
class TestWFEditorApplication:
    ...
    def app(self):
        ...
        # Mock dependencies
        with patch('simstack.WFEditorApplication.WFViewManager') as mock_view_manager_class, \
             patch('simstack.WFEditorApplication.QtClusterSettingsProvider') as mock_settings_class, \
             patch('simstack.WFEditorApplication.SSHConnector') as mock_connector_class, \
             patch('simstack.WFEditorApplication.logging'):
            ...
            with patch.object(WFEditorApplication, '__init__', lambda self: None):
                ...
                app._WFEditorApplication__settings = mock_settings  # Fix: use proper name mangling
    ...
    def test_on_save_paths(self, app):
        ...
        app._WFEditorApplication__settings.set_path_settings.assert_called_once_with(path_dict)
    ...
    def test_on_open_registry_settings(self, app):
        ...
        app._WFEditorApplication__settings.get_value.assert_called_once_with(SETTING_KEYS["registries"])
        
        # Verify dialog was opened with correct settings
        app._view_manager.open_dialog_registry_settings.assert_called_once_with(registry_settings)
    ...
    def test_on_open_path_settings(self, app):
        ...
        app._WFEditorApplication__settings.get_path_settings.return_value = path_settings
        ...
        # Verify dialog was opened with correct settings
        app._view_manager.open_dialog_path_settings.assert_called_once_with(path_settings)
    ...
    def test_on_error_not_connected(self, app):
        ...
        app._on_error("registry", uops.CONNECT_REGISTRY.value, uerror.REGISTRY_NOT_CONNECTED.value)
    ...
    def test_on_error_generic(self, app):
        ...
        app._on_error("registry", uops.DELETE_FILE.value, uerror.NO_ERROR.value, "Custom error message")
        
        # Verify show_error was called with correct arguments
        app._view_manager.show_error.assert_called_once_with("General Error.", "Custom error message")
    ...
    def test_on_run_single_job_error_not_connected(self, app):
        ...
        # Verify show_error was called with correct message
        app._view_manager.show_error.assert_called_once()
        assert "Registry must be connected" in app._view_manager.show_error.call_args[0][0]
    ...
    def test_on_file_deleted_success(self, app):
        ...
        app._on_file_deleted("registry", MagicMock(), ErrorCodes.NO_ERROR, to_del=file_to_delete)
