...
class TestSimStackEntryPoint:
    ...
    def test_main_linux_with_existing_settings(self, mock_yaml_load, mock_qtimer, mock_qtcore, 
                                             mock_style_factory, mock_ctypes, mock_logging,
                                             mock_uuid, mock_path_exists, mock_path_isdir, 
                                             mock_makedirs, mock_platform, mock_override_locale,
                                             mock_signal, mock_paths, mock_settings_provider,
                                             mock_wf_app, mock_qapp, mock_sys_exit):
        ...
        mock_paths.get_settings_file.return_value = "/home/user/.nanomatch/settings.yaml"
    ...
    @patch('simstack.SimStackEntryPoint.QtCore')
    @patch('simstack.SimStackEntryPoint.QTimer')
    def test_main_windows_no_existing_settings(self, mock_qtimer, mock_qtcore, mock_style_factory,
                                             mock_ctypes, mock_logging, mock_uuid, mock_path_exists,
                                             mock_path_isdir, mock_makedirs, mock_platform,
                                             mock_override_locale, mock_signal, mock_paths,
                                             mock_settings_provider, mock_wf_app, mock_qapp, mock_sys_exit):
        ...
        mock_settings.dump_to_file.assert_called_once_with("/home/user/.nanomatch/settings.yaml")
    ...
    @patch('simstack.SimStackEntryPoint.QtCore')
    @patch('simstack.SimStackEntryPoint.QTimer')
    def test_main_darwin_fusion_style(self, mock_qtimer, mock_qtcore, mock_style_factory,
                                    mock_ctypes, mock_logging, mock_uuid, mock_path_exists,
                                    mock_path_isdir, mock_makedirs, mock_platform, mock_override_locale,
                                    mock_signal, mock_paths, mock_settings_provider,
                                    mock_wf_app, mock_qapp, mock_sys_exit):
    ...
    def test_main_with_exception(self, mock_print_tb, mock_qtimer, mock_qtcore, mock_style_factory,
                               mock_ctypes, mock_logging, mock_uuid, mock_path_exists,
                               mock_path_isdir, mock_makedirs, mock_platform, mock_override_locale,
                               mock_signal, mock_paths, mock_settings_provider,
                               mock_wf_app, mock_qapp, mock_sys_exit):
        ...
        with patch('simstack.SimStackEntryPoint.sys.exc_info') as mock_exc_info:
            mock_exc_info.return_value = (type(test_exception), test_exception, "traceback")
            try:
                SimStackEntryPoint.main()
            except NameError:
