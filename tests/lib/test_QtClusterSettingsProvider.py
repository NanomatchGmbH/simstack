...
from simstack.lib.QtClusterSettingsProvider import (
    QtClusterSettingsProvider,
    QtSettingsChangedWorkaround,
)
...
class TestQtClusterSettingsProvider:
    ...
    def test_add_resource(self, provider):
        ...
        provider.add_resource.__self__.__class__.__bases__[0].add_resource = MagicMock(
        ...
        provider.add_resource.__self__.__class__.__bases__[
            0
        ].add_resource.assert_called_once_with(resource_name="test_resource")
    ...
    def test_remove_resource(self, provider):
        ...
        provider.remove_resource.__self__.__class__.__bases__[
            0
        ].remove_resource = MagicMock()
        ...
        provider.remove_resource.__self__.__class__.__bases__[
            0
        ].remove_resource.assert_called_once_with(resource_name="test_resource")

    @patch(
        "simstack.lib.QtClusterSettingsProvider.ClusterSettingsProvider.get_registries"
    )
