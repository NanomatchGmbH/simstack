...
from simstack.SSHConnector import SSHConnector, OPERATIONS, ERROR, eagain_catcher
...
class TestSSHConnector:
    ...
    def test_init(self, ssh_connector, mock_qtcluster_provider):
        ...
        assert ssh_connector._registries == mock_qtcluster_provider.get_registries.return_value
    ...
    def test_emit_error(self, ssh_connector):
        ...
        # Call the method
        ssh_connector._emit_error("base_uri", OPERATIONS.CONNECT_REGISTRY, ERROR.AUTH_SETUP_FAILED)
    ...
    def test_emit_error_with_message(self, ssh_connector):
        ...
        # Call the method
        ssh_connector._emit_error("base_uri", OPERATIONS.CONNECT_REGISTRY, ERROR.AUTH_SETUP_FAILED, "Error message")
    ...
    def test_connect_registry_disconnects_if_connected(self, mock_paths, ssh_connector, mock_clustermanager):
    ...
    @patch('simstack.SSHConnector.SimStackPaths')
    def test_connect_registry_new_connection(self, mock_paths, ssh_connector, mock_clustermanager):
        ...
        with patch.object(ssh_connector, 'start_server'), \
             patch.object(cm_instance, 'load_extra_host_keys'), \
    ...
    def test_connect_registry_raises_without_callback(self, mock_qmessagebox, mock_paths, ssh_connector, mock_clustermanager):
    ...
    def test_get_cm_not_connected(self, ssh_connector):
        ...
        # Verify
        assert "Clustermanager nonexistent_registry was not connected" in str(excinfo.value)
    ...
    def test_exec_callback_tuple(self, ssh_connector):
        ...
        # Verify
        callback_func.assert_called_once_with("cb_arg1", "cb_arg2", "arg1", "arg2", cb_kwarg="cb_value")
