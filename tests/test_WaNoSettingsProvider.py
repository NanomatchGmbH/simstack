...
class TestWaNoSettingsProvider:
    ...
    def test_set_path_settings(self, settings_provider):
        ...
        settings_provider.set_value.assert_any_call(SETTING_KEYS["wanoRepo"], "/test/wano/repo")
        settings_provider.set_value.assert_any_call(SETTING_KEYS["workflows"], "/test/workflows")
    ...
    def test_actual_defaults(self, settings_provider, temp_dir):
        ...
        real_provider = WaNoSettingsProvider(os.path.join(temp_dir, "real_settings.yaml"))
