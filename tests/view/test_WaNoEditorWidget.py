...
class TestWaNoEditor:
    ...
    def test_paint_event_empty(self, editor):
        ...
        # Mock QPainter
        with patch('simstack.view.WaNoEditorWidget.QtGui.QPainter') as mock_painter_class:
    ...
    def test_init_new_wano(self, editor):
        ...
        editor.tabWidget.addTab.assert_any_call(mock_wano.get_widget(), mock_wano.model.name)
        editor.tabWidget.addTab.assert_any_call(mock_wano.get_resource_widget(), "Resources")
        editor.tabWidget.addTab.assert_any_call(mock_wano.get_import_widget(), "Imports")
        editor.tabWidget.addTab.assert_any_call(mock_wano.get_export_widget(), "Exports")
    ...
    def test_init_with_changed_flag(self, editor):
        ...
        # Verify clear was called
        assert editor.clear.call_count == 2  # Called once before checking changedFlag and once after
    ...
    def test_close_action(self, editor):
        ...
        # Mock QMessageBox
        with patch('simstack.view.WaNoEditorWidget.QtWidgets.QMessageBox') as mock_msg_box:
            ...
            mock_instance.setText.assert_called_once_with("The Workflow Active Node Data has changed.")
            mock_instance.setInformativeText.assert_called_once_with("Do you want to save your changes?")
