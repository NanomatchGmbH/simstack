...
class TestWFEditorMainWindow:
    ...
    def main_window(self, qtbot):
        ...
        with patch.object(
            WFEditorMainWindow, "_WFEditorMainWindow__init_ui"
        ), patch.object(WFEditorMainWindow, "__init__", return_value=None), patch(
    ...
    def test_show_status_message(self, main_window):
        ...
        main_window._status_manager.add_message.assert_called_once_with(
            "Test message", 10
        )
    ...
    def test_close_event_accept(self, main_window):
        ...
        with patch(
            "simstack.view.WFEditorMainWindow.QMessageBox.question",
    ...
    def test_open_dialog_registry_settings(self, main_window):
        ...
        with patch(
            "simstack.view.WFEditorMainWindow.SimStackClusterSettingsView"
        ) as mock_dialog:
    ...
    def test_open_dialog_path_settings_accept(self, main_window):
        ...
        with patch("simstack.view.WFEditorMainWindow.WaNoPathSettings") as mock_dialog:
            ...
            mock_dialog.assert_called_once_with(
                parent=main_window, pathsettings=path_settings
            )
