...
class TestWFEditorMethods:
    ...
    def test_update_saved_workflows_list(self, mock_editor_instance):
        ...
        mock_editor_instance.workflowListWidget.update_list.assert_called_once_with(workflows)
    ...
    def test_update_registries(self, mock_editor_instance):
        ...
        WFEditor.update_registries(mock_editor_instance, registries, selected=selected_index)
    ...
    def test_update_filesystem_model(self, mock_editor_instance):
        ...
        mock_editor_instance.remoteFileTree.update_file_tree_node.assert_called_once_with(path, files)
    ...
    def test_update_job_list(self, mock_editor_instance):
        ...
        mock_editor_instance.remoteFileTree.update_job_list.assert_called_once_with(jobs)
    ...
    def test_update_workflow_list(self, mock_editor_instance):
        ...
        mock_editor_instance.remoteFileTree.update_workflow_list.assert_called_once_with(workflows)
    ...
    def test_openWorkFlow(self, mock_editor_instance):
        ...
        mock_editor_instance.workflowWidget.openWorkFlow.assert_called_once_with(workflow)
    ...
    def test_remove_with_wano_widget(self, mock_editor_instance):
        ...
        mock_editor_instance.wanoEditor.remove_if_open.assert_called_once_with(mock_wano_widget.wano_view)
    ...
    def test_run(self, mock_editor_instance):
        ...
        mock_editor_instance.workflowWidget.run.assert_called_once_with(current_registry)
