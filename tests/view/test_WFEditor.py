...
@pytest.mark.skip(reason="WFEditor is complex and requires extensive mocking of Qt components")
class TestWFEditor:
    ...
    def test_update_registries(self):
        ...
        editor.registrySelection.update_registries.assert_called_once_with(test_registries, index=test_selected)
    ...
    def test_update_filesystem_model(self):
        ...
        editor.remoteFileTree.update_file_tree_node.assert_called_once_with(test_path, test_files)
    ...
    def test_open_wano_editor_success(self):
        ...
        editor.settingsAndFilesTabs.setCurrentIndex.assert_called_once_with(editor.wanoSettingsTab)
