...
def test_drop_down_push_button_set_widget(qtbot):
    ...
    with patch.object(DropDownWidgetPushButton, "_init"), patch.object(
        DropDownWidgetPushButton, "_set_widget"
    ):
...
def test_drop_down_tool_button_set_widget(qtbot):
    ...
    # Create button without an initial widget
    with patch.object(DropDownWidgetToolButton, "_init"), patch.object(
        DropDownWidgetToolButton, "_set_widget"
    ):
