...
class TestWFTabsWidgetMethods:
    ...
    def test_contains_illegal_chars_comprehensive(
        self, mock_workflow_view, mock_wf_model
    ):
        ...
        tabs._contains_illegal_chars = WFTabsWidget._contains_illegal_chars.__get__(
            tabs, WFTabsWidget
        )
